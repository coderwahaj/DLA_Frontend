...
const PlatformSidebar = ({ onHistoryClick }) => {
  ...
  const navigationButtons = [
    { id: 'chat', label: 'Chat', icon: MessageSquare, path: '/platform' },
    { id: 'document', label: 'Document Summarizer', icon: FileText, path:  '/document-summarizer' },
    { id: 'precedents', label: 'Legal Precedents', icon: Scale, path: '/legal-precedents' }
  ];
